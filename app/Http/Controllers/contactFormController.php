...
class contactFormController extends Controller
{
     ...
     */
    public function store(StoreContactRequest $request)//でフォームで送信されたデータを取得してし、storeで保存している
    {
    ...
    public function update(Request $request, string $id)
    {
        ...
        $contact = ContactForm::find($id);
        $contact->name=$request->name;//$requestでformに入力された情報を取り出し、$contactでデータベースに登録している
