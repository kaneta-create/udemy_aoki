    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                @if ($errors->any())
                    <div class="alert alert-danger text-red-500">何か問題が発生しました
                        <ul>
                ...
                <div class="container px-5 mx-auto">
                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        <div class="relative">
                            ...
                            <select name="age"> 
                                <option value="" {{old('age')==0 ? 'selected' : ''}}>選択してください</option> 
                        ...
                        <div class="p-2 w-full">
                        <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">新規登録をする</button>
                        </div>
                    </div>
                    </div>
                </div>
